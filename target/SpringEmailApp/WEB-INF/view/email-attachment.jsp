...
<body>
		...
		<div class="container">
			...
			<form action="sendmailwithattach" method="post" enctype="multipart/form-data">
				<table class="table table-bordered" style="width: 60%">
					<thead>
						<tr>
							<th colspan="2"><center>Simple Mail with Attachment</center></th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							...
							<td><input type="file" name="file" required=""
								placeholder="Select File" class="form-control"></td>
						</tr>
						<tr>
				...
				<center>
					<a href="index">Send Simple Email</a>
				</center>
			</form>
		</div>
	</center>
